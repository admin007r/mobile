...
TOKEN = '6636097257:AAE7gHX7YGGSc52H3A5lhSpBlmPnWrKYfmM'
    ...
    await update.message.reply_text(
        ...
        reply_markup=ReplyKeyboardMarkup.from_button(
            ...
            KeyboardButton(
                ...
                web_app=WebAppInfo(url="https://f214-213-230-93-70.ngrok-free.app"),
...
def mai() -> None:
    ...
    application = Application.builder().token("6636097257:AAE7gHX7YGGSc52H3A5lhSpBlmPnWrKYfmM").build()
